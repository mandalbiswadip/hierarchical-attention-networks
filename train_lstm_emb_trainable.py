...
from models.model import word_list, max_sentences, maxlen, HierarchicalLSTMLayer
...
HierarchicalLSTMLayer.NUM_WORDS = len(word_list)
print(HierarchicalLSTMLayer.NUM_WORDS)
